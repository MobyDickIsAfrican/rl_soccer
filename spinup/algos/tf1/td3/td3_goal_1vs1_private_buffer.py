...
def td3(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=None, 
    ...
    for t in range(total_steps):
        ...
        replay_buffer.store(o[1].copy(), a[1].copy(), r[1], o2[1].copy(), d)
        ...
        if t >= update_after and t % update_every == 0:
            for j in range(update_every):
                batch_dicts = replay_buffer.sample_batch(batch_size)
                batch = {key: batch_dicts[key] for key in batch_dicts.keys()}
...
if __name__ == '__main__':
    ...
    logger_kwargs = setup_logger_kwargs(f'td3_soccer_goal_1vs1_{args.reward}_{args.control_timestep}', data_dir="/media/amtc/ab170e70-f9d7-4d20-a751-0c11c1ac7488/pavan/Proyecto_EL7021/models/TD3/paper/1vs1_prb", datestamp=True)
