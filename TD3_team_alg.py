...
class TD3_team_alg:
    ...
    def get_action(self,o, noise_scale):
        ...
        actions = np.array(self.home_ac.act(torch.as_tensor(o[:, self.home], dtype=torch.float32))\
                  + self.away_ac.act(torch.as_tensor(o[self.home:], dtype=torch.float32)))
...
if __name__ == '__main__':
    ...
    env_creator = lambda :   wrap.DmGoalWrapper(team_1=2, team_2=2) 
    T3 = TD3_team_alg(env_creator, 2, 2, logger_kwargs= logger_kwargs)   
    T3.train_agents()      
