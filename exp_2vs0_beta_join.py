...
from env_beta_2vs0 import stage_soccerTraining_beta
...
logger_kwargs = setup_logger_kwargs(f"td3_soccer_goal_beta_concat_2vs0_{args.control_timestep}", data_dir="roberto/Proyecto/2vs0", datestamp=True)
...
env_test_creator = lambda : stage_soccerTraining_beta(team_1=2, team_2=0, task_kwargs={"time_limit": args.time_limit, "disable_jump": True, 
