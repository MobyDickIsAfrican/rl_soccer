...
if __name__ == '__main__':
    ...
    logger_kwargs = setup_logger_kwargs(f'td3_soccer_goal_2vs0_{args.control_timestep}', data_dir="/media/amtc/ab170e70-f9d7-4d20-a751-0c11c1ac7488/roberto/Proyecto/2vs0", datestamp=True)
