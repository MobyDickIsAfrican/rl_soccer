...
env_creator = lambda :   Env2vs0(team_1=2, team_2=1,task_kwargs={ "time_limit": args.time_limit, "disable_jump": True, 
    "dist_thresh": 0.03, 'control_timestep': args.control_timestep,  "observables": "all"}) 
env_test_creator = lambda : Env2vs0(team_1=2, team_2=1, task_kwargs={"time_limit": args.time_limit, "disable_jump": True, 
