...
logger_kwargs = setup_logger_kwargs(f"td3_soccer_goal_pass_concat_2vs0_{args.control_timestep}", data_dir=args.save_path, datestamp=True)
...
env_test_creator = lambda : Env1vs0(1, 0, task_kwargs={'rew_type': 'simple_v2', 'time_limit': 30., 'disable_jump': True, 'dist_thresh': .03, 
                             'control_timestep': 0.1, 'random_state': 65,  "observables": "all"})
